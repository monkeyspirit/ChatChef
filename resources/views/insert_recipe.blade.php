            ...
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="nav-login-tab">
                ...
                <!-- Title -->
                    <div class="input-group mb-3">
                        ...
                        <input required id="title" name="title" type="text" class="form-control" aria-label="Title" aria-describedby="title">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            ...
                            <span class="input-group-text"><small id="charNumI">0</small><small>/350</small></span>
                        </div>
                        <textarea rows="5" class="form-control" required onkeyup="countCharIns(this)" id="description" name="description" aria-label="description" aria-describedby="description"></textarea>
                        <script>
                    ...
                    <div id="dynamicIngredient" class="form-row">
                        <!-- Name -->
                        <div class="col">
                            <input type="text" required class="form-control" placeholder= @lang('labels.ingredients') name="ingredients[]">
                        </div>
                            ...
                            $(add_button).click(function(e) {
                                ...
                                if (x < max_fields) {
                                    ...
                                    $(wrapper).append('<div id="dynamicIngredient" class=" p-2 form-row">' +
                                        '<!-- Name -->\n' +
                                        '                                    <div class="col">\n' +
                                        '                                        <input required type="text" class="form-control" placeholder=@lang('labels.ingredients') name="ingredients[]">\n' +
                                        '                                    </div>\n' +
                                        '\n' +
                                        '                                    <!-- Quantity -->\n' +
                                        '                                    <div class="col">\n' +
